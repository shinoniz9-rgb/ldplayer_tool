...
if __name__ == "__main__":
    ...
    # 1. Quét ảnh e_buoc1.png
    print("Đang quét ảnh e_buoc1.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_buoc1.png", threshold=0.85)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 2. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 20 giây...")
    time.sleep(20)

    # 3. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    time.sleep(2)

    # 4 . Quét ảnh e_buoc1.png
    print("Đang quét ảnh e_buoc1.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_buoc1.png", threshold=0.85)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 5. Quét ảnh e_buoc2.png cho đến khi thấy ảnh e_tieptheo.png hiện ra
    print("Đang quét ảnh e_buoc2.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_buoc2.png", threshold=0.80)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 6. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 20 giây...")
    time.sleep(20)

    # 7. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 8. Quét ảnh e_buoc2.png
    print("Đang quét ảnh e_buoc2.png...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_buoc2.png", threshold=0.80, interval=0.3)
    print("Nghỉ 4 giây...")
    time.sleep(4)

    # 9. Tap tọa độ (225, 220) -> Nghỉ 1s
    tap(225, 220)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 10. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) hiện 2 lầnnnnnnnnnnnnnnnnnnnnnnnnnnn
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 40 giây...")
    time.sleep(40)

    # 11. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 2 giây...")
    time.sleep(2)
    
    # 12. Quét ảnh e_buoc3.png
    print("Đang quét ảnh e_buoc3.png...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_buoc3.png", threshold=0.80, interval=0.3)
    print("Nghỉ 5 giây...")
    time.sleep(5)
