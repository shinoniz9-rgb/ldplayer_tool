...
if __name__ == "__main__":
    ...
    # 1. Tìm ảnh , nếu thấy tap vào bỏ qua tap tọa độ 1240, 680 , ko thấy thì tap tọa độ
    print("Đang quét ảnh e_sukien.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_sukien.png", threshold=0.85)
    print("Nghỉ 1 giây...")
    time.sleep(1)

    # 1. Tap tọa độ (1240, 680) -> Nghỉ 1s
    tap(1240, 680)
    print("Nghỉ 1 giây...")
    time.sleep(1)

    # 2. Quét e_sukien.png -> Nghỉ 1s
    print("Đang quét ảnh e_sukien.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_sukien.png", threshold=0.85)
    print("Nghỉ 1 giây...")
    time.sleep(1)
    ...
    # 4. Quét e_dichuyen.png -> Nghỉ 1s
    print("Đang quét ảnh e_dichuyen.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_dichuyen.png", threshold=0.85)
    print("Nghỉ 3 giây...")
    time.sleep(3)

    # 1. Tìm ảnh , nếu thấy tap vào 1240, 680 , ko thấy bỏ qua
    print("Đang quét ảnh e_sukien.png...")
    find_and_click_image(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_sukien.png", threshold=0.85)
    print("Nghỉ 1 giây...")
    time.sleep(1)
