...
if __name__ == "__main__":
    ...
    # 1. Tap tọa độ (805, 160)
    tap(805, 160)
    print("Nghỉ 3 giây...")
    time.sleep(3)

    # 2. Tap tọa độ (1025, 150)
    tap(1025, 150)
    print("Nghỉ 1 giây...")
    time.sleep(1)

    # 3. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)
    ...
    # 4. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    time.sleep(2)
    ...
    # 7. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 50 giây...")
    time.sleep(50)

    # 8. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    time.sleep(2)

    # 9. Tap tọa độ (200, 250)
    tap(200, 250)
    print("Nghỉ 3 giây...")
    time.sleep(3)

    # 10. Tap tọa độ (730, 50)
    tap(730, 50)
    print("Nghỉ 3 giây...")
    time.sleep(3)

    # 11. Tap tọa độ (1030, 160)
    tap(1030, 160)
    print("Nghỉ 2 giây...")
    time.sleep(2)

    # 12. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    print("Nghỉ 50 giây...")
    time.sleep(50)

    # 13. Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s) kết thúc
    print("👁️ [Bước 3] Quét ảnh e_tieptheo.png đến khi mất ảnh (mỗi 0.3s)...")
    click_until_disappear(r"C:\Users\Phat\Downloads\ldplayer_tool\assets\card_e\e_tieptheo.png", threshold=0.75, interval=0.3)
    time.sleep(1)

    # 14. Tap tọa độ (1250, 170)
    tap(1250, 170)
    print("Nghỉ 4 giây...")
    time.sleep(4)
